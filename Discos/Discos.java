...
public class Discos{
  public static void main(String[] args){
    // array
      ...
      // creación
        PruebaDiscos[] album=new PruebaDiscos[t];

      /***************/

      // instancias de base
        for(int i=0; i<t; i++){
          album[i]=new PruebaDiscos(null, null, null, null, i);
        }
      ...
      do{
        ...
        switch(opcion){
          case 1:
            ...
            for(int i=0; i<t; i++){
              if(!album.equals("LIBRE")){// se muestran todas las instancias que no están libres
